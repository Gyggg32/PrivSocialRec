...
predictions = sl_model.predict(data,batch_size=128)

recommendations = predictions.sort_values(by='PredictedRating', ascending=False)

top_n = 5
top_recommendations = recommendations.groupby('UserName').head(top_n)
